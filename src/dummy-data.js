const data = [
    {
        ...
        correctAnswer: 'A library for managing state in web applications.',
      },
      {
        id: 'q2',
        ...
        correctAnswer: 'Part of the Redux library for managing global state.',
      },
      {
        id: 'q3',
      ...
      //   ],
      //     correctAnswer: 'By defining a custom HTML tag in JavaScript.',
      // },
      // {
      //   id: 'q5',
      ...
      //   ],
      //     correctAnswer: 'By using the forEach() method to iterate over an array of data and returning JSX.',
      // },
      // {
      //   id: 'q7',
